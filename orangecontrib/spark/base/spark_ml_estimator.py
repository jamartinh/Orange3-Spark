...
from ..utils.ml_api_utils import get_estimators, get_object_info


class OWSparkEstimator:
    # widget_id = None
    ...
    def __init__(self):
        ...
        self.module_methods = get_estimators(self.module)
        ...
        # Action Button
        self.create_sc_btn = gui.button(self.action_box, self, label = 'Apply', callback = self.fit)
